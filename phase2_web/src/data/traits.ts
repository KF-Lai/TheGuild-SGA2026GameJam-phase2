...
export interface ProfessionTrait {
  ...
  /** 各任務類型的成功率修正（%，e.g. 20 = +20%）
   *  Phase 2：STRONG_TYPE_BONUS = +20、WEAK_TYPE_PENALTY = -15，其餘為 0 */
...
export const PROFESSION_TRAITS: Record<ProfessionId, ProfessionTrait> = {
  warrior: {
    ...
    successRateModifier: { 討伐: STRONG_TYPE_BONUS * 100, 護送: 0, 採集: 0, 調查: -(WEAK_TYPE_PENALTY * 100) },
  },
  mage: {
    id: 'mage', professionID: 2, name: '法師',
    strongTypes: ['調查'], weakTypes: ['採集'],
    successRateModifier: { 討伐: 0, 護送: 0, 採集: -(WEAK_TYPE_PENALTY * 100), 調查: STRONG_TYPE_BONUS * 100 },
  },
  ranger: {
    id: 'ranger', professionID: 3, name: '遊俠',
    strongTypes: ['採集'], weakTypes: ['護送'],
    successRateModifier: { 討伐: 0, 護送: -(WEAK_TYPE_PENALTY * 100), 採集: STRONG_TYPE_BONUS * 100, 調查: 0 },
  },
  scout: {
    id: 'scout', professionID: 4, name: '斥侯',
    strongTypes: ['護送', '調查'], weakTypes: ['討伐'],
    successRateModifier: { 討伐: -(WEAK_TYPE_PENALTY * 100), 護送: STRONG_TYPE_BONUS * 100, 採集: 0, 調查: STRONG_TYPE_BONUS * 100 },
  },
  guardian: {
    id: 'guardian', professionID: 5, name: '盾衛',
    strongTypes: ['護送'], weakTypes: ['調查'],
    successRateModifier: { 討伐: 0, 護送: STRONG_TYPE_BONUS * 100, 採集: 0, 調查: -(WEAK_TYPE_PENALTY * 100) },
  },
  healer: {
    id: 'healer', professionID: 6, name: '治癒師',
    strongTypes: ['護送'], weakTypes: ['討伐'],
    successRateModifier: { 討伐: -(WEAK_TYPE_PENALTY * 100), 護送: STRONG_TYPE_BONUS * 100, 採集: 0, 調查: 0 },
  },
  mercenary: {
