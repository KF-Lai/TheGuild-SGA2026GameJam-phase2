...
export type AdventurerStatus = 'idle' | 'on_mission' | 'dead' | 'wounded'
...
// Phase 2 新增
export type GuildLevel = 1 | 2 | 3 | 4 | 5

export type StaffEffectType =
  | 'willingness_bonus'
  | 'commission_bonus'
  | 'recruit_refresh_reduction'
  | 'none'
