...
| 19  | P-02-FSD-A Main UI Core       | 已完成 | 2026-05-02 | 2026-05-02 | P-02-FSD-A 實作完成（使用者口頭確認，2026-05-02）；FSD 涵蓋 14 Script 預估 2110~2660 行（PanelManager / PanelStateMachine / UIBootstrapController / UITextService / SceneNavigationController / PersistentHudController / StoryDialogueQueue / SceneObjectController / SceneObjectStateLoader / DialogueRenderer / ScreenAnchorCalculator / LogFloatingWindowHost / P02UITuning / PanelTypes）；P-02-DS（ui-text / scene-object-state-table）已建立；CSV（UIText / SceneObjectStateTable）已落地；詳細實作備註待補（self-check 輪數 / 測試結果 / commit hash）|
| 20  | P-02-FSD-B Main UI Panels     | 已完成 | 2026-05-02 | 2026-05-02 | P-02-FSD-B 實作完成（使用者口頭確認，2026-05-02）；FSD 涵蓋 11 Script 預估 2050~2580 行（CommissionBoardPanel / RecommendAdventurerSubpanel / AdventurerRosterPanel / GuildBuildingPanel / StaffRosterPanel / StaffGachaPanel / GuildOverviewPanel / StoryDialoguePanel / ConfirmPopup / SettingsPanel / LogFloatingWindowTemplate + IPanel）；依賴 FSD-A `PanelManager` / `UITextService` / `DialogueRenderer` / `ScreenAnchorCalculator`；詳細實作備註待補（self-check 輪數 / 測試結果 / commit hash）|
