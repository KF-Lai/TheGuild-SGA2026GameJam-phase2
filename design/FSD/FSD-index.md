...
| P-01 | Desktop Transparent Window | 無 CSV 引用；§7 5 個 tuning knob 收錄於 `P01Tuning.asset`（ScriptableObject，不對應 Data-Specs） | [【P-01-FSD】desktop-transparent-window.md](【P-01-FSD】desktop-transparent-window.md) | 未拆分 FSD，內含 6 Script + 1 ScriptableObject + 1 asset（Win32Native / MonitorInfo / MonitorEnumerator / WindowHitTester / WindowScaleController / DesktopWindowService + P01Tuning class & asset，預估 720~1050 行；2026-05-03 design-review 移除 IDesktopWindowService 違反 §2.10）|
| P-02 | Main UI Framework | [`【P-02-DS】ui-text.md`](../Data-Specs/【P-02-DS】ui-text.md)（CSV：`UIText.csv`，owner = P-02-FSD-A）<br>[`【P-02-DS】scene-object-state-table.md`](../Data-Specs/【P-02-DS】scene-object-state-table.md)（CSV：`SceneObjectStateTable.csv`，owner = P-02-FSD-A，v3.1 P3.1-010）<br>消費端：[`【FT-07-DS】building-table.md`](../Data-Specs/【FT-07-DS】building-table.md)、[`【FT-12-DS】staff-table.md`](../Data-Specs/【FT-12-DS】staff-table.md)（_待建_）、`【FT-08-DS】staff-refresh-cost-table.md`（_待建_）、[`【C-01-DS】mission-template.md`](../Data-Specs/【C-01-DS】mission-template.md)、[`【C-01-DS】mission-difficulty-table.md`](../Data-Specs/【C-01-DS】mission-difficulty-table.md)、`【FT-06-DS】guild-level-table.md`（_待建_）、[`【FT-09-DS】faction-route-table.md`](../Data-Specs/【FT-09-DS】faction-route-table.md) | [【P-02-FSD-A】main-ui-core.md](【P-02-FSD-A】main-ui-core.md)<br>[【P-02-FSD-B】main-ui-panels.md](【P-02-FSD-B】main-ui-panels.md) | 拆 A/B（FSD-A：框架核心 + 場景整合 + 啟動握手 + 文字驅動，14 Script 預估 2110~2660 行；FSD-B：11 Script + 1 組 LogFloatingWindow UXML/USS 資產，預估 1990~2500 行；合計 25 Script + 1 資產 ~4100~5160 行）|
...
| [`【P-02-DS】ui-text.md`](../Data-Specs/【P-02-DS】ui-text.md) | `UIText.csv` | P-02 | [【P-02-FSD-A】main-ui-core.md](【P-02-FSD-A】main-ui-core.md)（owner）、[【P-02-FSD-B】main-ui-panels.md](【P-02-FSD-B】main-ui-panels.md)（消費端：所有面板文字 lookup） |
| [`【P-02-DS】scene-object-state-table.md`](../Data-Specs/【P-02-DS】scene-object-state-table.md) | `SceneObjectStateTable.csv` | P-02（v3.1 P3.1-010） | [【P-02-FSD-A】main-ui-core.md](【P-02-FSD-A】main-ui-core.md)（owner，SceneObjectController 解析資料源） |
...
| `【P-02-FSD-A】main-ui-core.md`           | P-02   | 已完成 | Claude Code 主體（直接撰寫，無 subagent；Opus 4.7 + xhigh）                                   | 2026-05-02 | 2026-05-02 | 正向 FSD（無既有 UI Script，greenfield）；P-02 GDD 拆 A/B 兩份，本檔為 A（框架核心 + 場景整合 + 啟動握手 + 文字驅動），預估 14 Script、2110~2660 行；GDD §3.1 / §3.2 / §3.3 / §3.4 / §3.5.7 / §3.5.9（API 簽章）/ §3.6 / §3.7 / §3.8 / §3.9 共 10 子節全部「對齊」；GDD §4 全節公式直接採用偽碼（World-to-Screen / SplitDialogue / 淡入淡出 / Log clamp / hover outline 矩形）；GDD §5 EC-01~EC-26 中 17 條與 FSD-A 相關全有對策；GDD §8 DoD-A1~A14 對齊 AC-01~AC-12 / AC-13~AC-18 / AC-33~AC-39 / AC-40~AC-42 / AC-43~AC-45；§3.8 OnUIReady step 3 主動查詢 + FT-09 Step F 重發雙重保險；§7.1 P02UITuning ScriptableObject 收 10 個視覺/動畫常量 + 6 個字體大小；建議項 A-01（審查處 buildingID 待 FT-07 P3.1-009）/ A-02（DialogueTable owner 待定）/ A-03（P-03 Critical 通知 query API）/ A-04（P-02-DS 已建立）/ A-05（USER_SCALE_STEP 跨 FSD）/ A-06（ISaveable 「最後 base panel ID」可選持久化）皆不阻擋實作；§8.4 無 GDD 回註；§8.5 無衝突。**[2026-05-02 實作完成]** 程式碼實作落地（使用者口頭確認 P-02 全數實作完成） |
| `【P-02-FSD-B】main-ui-panels.md`         | P-02   | 已完成 | Claude Code 主體（直接撰寫，無 subagent；Opus 4.7 + xhigh）                                   | 2026-05-02 | 2026-05-02 | 正向 FSD（無既有 UI Script，greenfield）；本檔為 P-02 拆分後 B（10 個 L2 面板實作 + 1 inline subpanel + Log UXML 模板），預估 11 Script、2050~2580 行；GDD §3.5.1~§3.5.10 全對齊（10 子節）；GDD §8.5 AC-19~AC-26 / §8.6 AC-27~AC-32 / §8.10 AC-43~AC-45 對應 DoD-B1~B16；GDD §5 EC-10~EC-14 / EC-17 / EC-18 / EC-26 共 7 條與 FSD-B 相關皆有對策；本 FSD 為 panel consumer，依賴 FSD-A `PanelManager` / `UITextService` / `DialogueRenderer` / `ScreenAnchorCalculator`；推薦冒險者子面板 Jam 版不顯示 willingness 預估（FT-02/FT-03 未提供 API）；StoryDialoguePanel epilogue 透過 `IsEpilogue` 旗標分流不呼叫 ConfirmDialogue；建議項 B-01~B-09 皆不阻擋實作；§8.4 無 GDD 回註；§8.5 無衝突。**[2026-05-02 實作完成]** 程式碼實作落地（使用者口頭確認 P-02 全數實作完成） |
| `【P-01-FSD】desktop-transparent-window.md` | P-01 | 已完成 | Claude Code 主體（直接撰寫，無 subagent；Opus 4.7 + xhigh） | 2026-05-03 | 2026-05-03 | 正向 FSD（無既有 Win32 / Desktop Script，greenfield）；FSD 未拆分（**6 Script + 1 ScriptableObject + 1 asset**：Win32Native / MonitorInfo / MonitorEnumerator / WindowHitTester / WindowScaleController / DesktopWindowService + P01Tuning class & asset，預估 720~1050 行；最大單 Script DesktopWindowService 280~380 行 < 500 行不需拆 FSD）；GDD §3.1~§3.8 全對齊；GDD §4 三條公式（baseResolutionScale / effectiveScale / windowHeight）直接採用偽碼；GDD §5 邊界情況 8 條全有對策（§7）+ 額外 5 條實作期 EC；GDD §8 AC-01~AC-11 對齊 §1.3 DoD-01~DoD-12；無 CSV 引用，§7 5 個 tuning knob 全收錄於 P01Tuning ScriptableObject（§6.2/§6.3）；§8.4 無 GDD 回註；§8.5 無衝突；**[2026-05-03 design-review patch]** ✓ C1 P0（§4.4 移除 IDesktopWindowService 違反 §2.10）；✓ C2 P1（§5.4.2 WndProc 委派 _hitTester.HitTest + WindowHitTester 整流程）；✓ I1 P2（§4.5 補 [DefaultExecutionOrder(100)] 對齊基準）；✓ I2 P2（EnsureSingleton 偽碼展開）；✓ I3 P2（Start Step 1 補 race fallback + §7 EC 新列）；✓ I4 P3（P01Tuning 路徑明定獨立 P01Tuning.cs）；✓ I5 P3（WindowHitTester 改 Func<IPanel> provider + §7 EC UIDocument reload 列）；建議項 B-01~B-04 皆不阻擋實作；**[2026-05-03 使用者複核]** 通過，狀態 審查中 → 已完成；**[2026-05-03 實作落地]** unity-specialist subagent (Sonnet+high) fallback 落地（codex-mcp/gpt-mcp token 上限禁用）；7 .cs runtime 1308 行 + asmdef + AssemblyInfo + P01Tuning.asset；自檢 5 輪 fix（R1 MarkSaveDataDirty / R2 WindowHitTester #if 包覆 / E1 HitTest→HitTestResult / E2 SaveLoadService.Instance / R3 IPanel ambiguity）；跨層 patch 3 處（PanelManager.GetMainSceneRootPanel / UIBootstrapController.MainSceneDocument 屬性 / SaveLoadService.Instance getter）；EditMode 290/299 + 9 既有 [Ignore] / PlayMode 13/13 全綠；ImplementationGuide §6 row 21 已登記 |
