...
| 4 | 公會櫃臺 | 1 | 5 | 同時任務上限 |
| 5 | 預備金保險櫃 | 1 | 5 | 破產倒數秒數 |
| 6 | 職員休息室 | 0 | 1（Jam 版，FT-08 完成後擴展） | 職員系統解鎖 |
...
**Case 5.7 — 職員休息室 L1→L2 升級（FT-08 尚未設計）**
- 情境：玩家建造職員休息室後嘗試繼續升級
- 行為：`BuildingTable[6].maxLevel` 在 Jam 版設為 `1`，升級按鈕顯示「已滿級」；FT-08 完成後更新 `maxLevel` 與 `upgradeData`
- 文件標註：Jam 版職員休息室最高 L1，此為設計上的暫時限制
...
**檔案位置**：`Assets/Resources/Data/BuildingTable.csv`
...
| buildingID | name | maxLevel | level | effectValue | upgradeCost | guildLevelReq |
|---|---|---|---|---|---|---|
| 1 | 委託板 | 5 | 1 | 5 | 0 | 0 |
| 1 | 委託板 | 5 | 2 | 8 | 150 | 0 |
| 1 | 委託板 | 5 | 3 | 11 | 350 | 3 |
| 1 | 委託板 | 5 | 4 | 14 | 700 | 4 |
| 1 | 委託板 | 5 | 5 | 17 | 1200 | 5 |
| 2 | 招募廣告欄 | 3 | 1 | 86400 | 0 | 0 |
| 2 | 招募廣告欄 | 3 | 2 | 57600 | 250 | 0 |
| 2 | 招募廣告欄 | 3 | 3 | 28800 | 600 | 3 |
| 3 | 公會大廳 | 5 | 1 | 10 | 0 | 0 |
| 3 | 公會大廳 | 5 | 2 | 15 | 400 | 0 |
| 3 | 公會大廳 | 5 | 3 | 20 | 900 | 3 |
| 3 | 公會大廳 | 5 | 4 | 25 | 1600 | 4 |
| 3 | 公會大廳 | 5 | 5 | 30 | 2500 | 5 |
| 4 | 公會櫃臺 | 5 | 1 | 5 | 0 | 0 |
| 4 | 公會櫃臺 | 5 | 2 | 8 | 250 | 0 |
| 4 | 公會櫃臺 | 5 | 3 | 11 | 500 | 3 |
| 4 | 公會櫃臺 | 5 | 4 | 14 | 900 | 4 |
| 4 | 公會櫃臺 | 5 | 5 | 18 | 1400 | 5 |
| 5 | 預備金保險櫃 | 5 | 1 | 10800 | 0 | 0 |
| 5 | 預備金保險櫃 | 5 | 2 | 21600 | 200 | 0 |
| 5 | 預備金保險櫃 | 5 | 3 | 43200 | 450 | 3 |
| 5 | 預備金保險櫃 | 5 | 4 | 86400 | 800 | 4 |
| 5 | 預備金保險櫃 | 5 | 5 | 172800 | 1500 | 5 |
| 6 | 職員休息室 | 1 | 0 | 0 | 0 | 0 |
| 6 | 職員休息室 | 1 | 1 | 1 | 500 | 0 |

> 招募廣告欄 `effectValue` 單位為秒（86400 = 24h，57600 = 16h，28800 = 8h）。預備金保險櫃同。職員休息室 L1 `effectValue = 1` 為 `IsStaffSystemUnlocked()` 的布林語意（0 = false，1 = true）。
...
| 調整破產倒數緩衝 | `effectValue`（buildingID=5） | 最短 1800s（30min），最長 604800s（7 天） | 若低於 3600s，玩家幾乎沒有反應時間 |
...
- 職員休息室 Jam 版 `maxLevel = 1`（FT-08 完成前不變動）
