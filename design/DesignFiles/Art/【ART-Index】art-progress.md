...
_最後更新：2026-05-01_
_規格來源：`【ART-01】art-requirements.md` v1.5_
...
| D-2a | 茶杯（熱） | `Props/teacup_hot.png` | 512×512 | P0 | 待製作 | 白煙 2~3 縷 |
| D-2b | 茶杯（冷） | `Props/teacup_cold.png` | 512×512 | P0 | 待製作 | 無煙、有水漬 |
| D-2c | 茶杯（空） | `Props/teacup_empty.png` | 512×512 | P0 | 待製作 | 空杯、舊水漬、灰塵感 |
