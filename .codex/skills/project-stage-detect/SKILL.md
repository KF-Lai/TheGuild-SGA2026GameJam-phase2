...
Use this skill when the user invokes $project-stage-detect or asks for work matching the description. This skill is compatible with both Codex and GPT contexts.
...
- Treat legacy slash-command examples as invocation examples; prefer $project-stage-detect <args> when referring to this skill.
