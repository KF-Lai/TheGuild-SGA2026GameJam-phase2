...
Use this skill when the user invokes $auto-code-optimize-batch or asks for work matching the description. This skill is compatible with both Codex and GPT contexts.
...
- Treat legacy slash-command examples as invocation examples; prefer $auto-code-optimize-batch <args> when referring to this skill.
